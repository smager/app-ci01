...
function displayRecords(){   
    ...
    zsi.json.loadGrid({
        ...
        ,td_body: [ 
            function(d){
                return     bs({name:"supply_type_id[]",type:"hidden",value: d.supply_type_id})
                        +  bs({name:"cb[]",type:"checkbox"});
            }
            ,function(d){ return bs({name:"supply_type[]",value: d.supply_type}); }
        ]
        ,onComplete : function(){
            displayBlankRows();
        }
...
function displayBlankRows(){       
    ...
    zsi.json.loadGrid({
        ...
        ,td_body: [ 
            function(d){
                return     bs({name:"supply_type_id[]",type:"hidden"})
                        +  bs({name:"cb[]",type:"checkbox"});
            }            
            ,function(d){ return bs({name:"supply_type[]"}); }
        ]
    });
