...
function displayRecords(){   
    ...
    zsi.json.loadGrid({
        ...
        ,td_body: [ 
            function(d){
                return     bs({name:"unit_id[]",type:"hidden",value: d.unit_id})
                        +  bs({name:"cb[]",type:"checkbox"});
            }
            ,function(d){ return bs({name:"unit_sdesc[]",value: d.unit_sdesc}); }
            ,function(d){ return bs({name:"unit_desc[]",value: d.unit_desc}); }
        ]
        ,onComplete : function(){
            displayBlankRows();
        }
...
function displayBlankRows(){       
    ...
    zsi.json.loadGrid({
        ...
        ,td_body: [ 
            function(d){
                return     bs({name:"unit_id[]",type:"hidden"})
                        +  bs({name:"cb[]",type:"checkbox"});
            }            
            ,function(d){ return bs({name:"unit_sdesc[]"}); }
            ,function(d){ return bs({name:"unit_desc[]"}); }
        ]
    });
