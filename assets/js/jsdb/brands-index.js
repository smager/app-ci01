...
function displayRecords(){   
    ...
    zsi.json.loadGrid({
        ...
        ,td_body: [ 
            function(d){
                return     bs({name:"brand_id[]",type:"hidden",value: d.brand_id})
                        +  bs({name:"cb[]",type:"checkbox"});
            }
            ,function(d){ return bs({name:"brand_name[]",value: d.brand_name}); }
        ]
        ,onComplete : function(){
            displayBlankRows();
        }
...
function displayBlankRows(){       
    ...
    zsi.json.loadGrid({
        ...
        ,td_body: [ 
            function(d){
                return     bs({name:"brand_id[]",type:"hidden"})
                        +  bs({name:"cb[]",type:"checkbox"});
            }            
            ,function(d){ return bs({name:"brand_name[]"}); }
        ]
    });
